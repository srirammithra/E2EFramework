...
public class TC05CreateNewTaskTest extends TestBase {

	public static WebDriver driver;

	@Test
	public void TC05CreateNewTask() throws FileNotFoundException, IOException, InterruptedException {
		...
		Thread.sleep(5000);
		objExtentTestSync.get().log(Status.INFO, "Add new task");
		objTasksPage.AddNewTask(objTestDataProperties.getProperty("TaskName"));
	}
}
